...
Item {
    ...
    readonly property string rtlTitle:                      qsTr("착륙")
    readonly property string takeoffTitle:                  qsTr("이륙")
    ...
    readonly property string startMissionMessage:               qsTr("지상에서 이륙하여 현재 임무를 시작하십시오.")

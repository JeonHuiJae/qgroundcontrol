...
void QGCPalette::_buildMap()
{
    ...
    DECLARE_QGC_COLOR(button,               "#ffffff", "#ffffff", "#A6A6A6", "#707070")
    DECLARE_QGC_COLOR(buttonText,           "#9d9d9d", "#000000", "#A6A6A6", "#ffffff")
    DECLARE_QGC_COLOR(buttonHighlight,      "#e4e4e4", "#946120", "#3a3a3a", "#3a3a3a")
    DECLARE_QGC_COLOR(buttonHighlightText,  "#2c2c2c", "#ffffff", "#2c2c2c", "#A6A6A6")

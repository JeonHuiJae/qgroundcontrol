...
void QGCPalette::_buildMap()
{
    ...
    DECLARE_QGC_COLOR(button,               "#ffffff", "#ffffff", "#585858", "#A6A6A6")
    DECLARE_QGC_COLOR(buttonText,           "#9d9d9d", "#000000", "#A6A6A6", "#F9AE00")
    DECLARE_QGC_COLOR(buttonHighlight,      "#e4e4e4", "#946120", "#3a3a3a", "#F9AE00")
    DECLARE_QGC_COLOR(buttonHighlightText,  "#2c2c2c", "#ffffff", "#E2E2E2", "#ffffff")
    ...
    DECLARE_QGC_COLOR(hoverColor,           "#585858", "#dbfef8", "#585858", "#222222")

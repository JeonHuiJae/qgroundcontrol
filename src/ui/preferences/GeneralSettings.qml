            ...
            ColumnLayout {
                ...
                Rectangle {
                    ...
                    GridLayout {
                        ...
                        Repeater {
                            model: [ qsTr("거리"), qsTr("면적"), qsTr("속력"), qsTr("온도") ]
                ...
                //                            QGCLabel { text: qsTr("앱 불러오기/저장 경로") }
                //                            QGCTextField {
                //                                Layout.fillWidth:   true
                //                                readOnly:           true
                ...
                //                            }
                //                            QGCLabel {
                //                                text:       qsTr("데이터 유지가 비활성화되면 모든 원격 분석 로깅 및 지도 캐싱이 비활성화되고 디스크에 기록되지 않습니다.")
